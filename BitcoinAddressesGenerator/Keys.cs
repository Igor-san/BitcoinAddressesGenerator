...
namespace Casascius.Bitcoin
{
    ...
    public class KeyPair : PublicKey
    {
        ...
        /// <summary>
        /// Создаю из байтового архива
        /// </summary>
        /// <param name="bi"></param>
        /// <param name="compressed"></param>
        /// <param name="addressType"></param>
        /// <returns></returns>
        public static KeyPair Create(byte[] newkey, bool compressed = false, byte addressType = 0)
        {
            return new KeyPair(newkey, compressed: compressed, addressType: addressType);
        }

        public static KeyPair Create(BigInteger bi, bool compressed = false, byte addressType = 0)
        {
            return new KeyPair(bi, compressed: compressed, addressType: addressType);
        }
